...
#### Q: When does the FedRAMP expect CSPs will need to begin planning and migrating to the OSCAL process?
...
#### Q: Will the PMO release any learning resources for stakeholders who are not very familiar with OSCAL?

**A:** FedRAMP is actively updating technical documentation and guidance on this website.  Additionally, FedRAMP will be launching a training initiative which will include OSCAL-specific topics. Please stay tunned for more details.   
